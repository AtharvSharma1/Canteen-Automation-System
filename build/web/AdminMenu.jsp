<%-- 
    Document   : Menu
    Created on : 4 Apr, 2023, 9:27:21 PM
    Author     : ashug
--%>
        ...
        <table style="margin-top: 5vh;" class="table user-list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="PurchaseItemChecker" method="post">
                        <input type="hidden" name="id" value="<%=rs.getString("ItemId")%>">
                        <input type="hidden" name="username" value="<%=username%>">
                        <input style="width: 9vh;border-radius: 2vh;color: aliceblue;height: 3.5vh; border: none;background-color: rgb(0, 201, 97);" value="Purchase" type="submit">
                        </form>
                    </td>
