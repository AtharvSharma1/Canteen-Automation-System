...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <tr>
                <td><a href="AddEmployee.html"><button>Add Employee</button></a></td>
                <td><form method="post" action="EmployeeList.jsp">
                    
                        <input style="max-width: 80vh;width: 40vh; border-radius: 2vh;border: none; height: 5vh;margin-right:1vh ;padding-left: 1vh;" type="search" name="id" placeholder="Search with Employee id" maxlength="15">
