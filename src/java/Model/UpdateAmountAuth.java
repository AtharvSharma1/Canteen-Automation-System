...
//        System.out.println(amt);
        ...
        { 
            Statement st=dbConnector.getStatement();
            String query1 = "INSERT INTO transaction(`by`,`to`,`type`,`amount`) VALUES('Canteen','"+name+"','Credit','"+amt+"')";
//          System.out.println("Query = "+query);
            st.executeUpdate(query1);
            
            String query2 = "INSERT INTO `debittrans`(`type`,`from`,`amount`,`type2`,`to`,`purchased`) VALUES('Debited','Canteen','"+amt+"','Creadit','"+name+"','Nothing')";
